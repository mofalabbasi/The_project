  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-5 mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link active p-2 p-lg-3" aria-current="page" href="Abook.php">Books</a>
        </li>
        <li class="nav-item">
          <a class="nav-link p-2 p-lg-3" href="Auser.php">Users</a>
        </li>
        <li class="nav-item">
          <a class="nav-link p-2 p-lg-3" href="Aorder.php">Orders</a>
        </li>
        <li class="nav-item">
