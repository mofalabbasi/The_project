  ...
  <div class="container">
    ...
    <div class="navbar-collapse collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-5 mb-2 mb-lg-0">
        <li class="nav-item"><a class="nav-link p-2 p-lg-3" aria-current="page" href="home.php">Home</a></li>
        <li class="nav-item"><a class="nav-link p-2 p-lg-3" href="books.php">Books</a></li>
        <li class="nav-item"><a class="nav-link p-2 p-lg-3" href="cart.php">Cart</a></li>
        <li class="nav-item"><a class="nav-link p-2 p-lg-3" href="about.php">about</a></li>
        <li class="nav-item"><a class="nav-link p-2 p-lg-3" href="contact.php">contact</a></li>
      </ul>
    ...
    <div>
      <?php echo "<img class='rounded-circle position-absolute bg-light' width='40px' height='40px' src='" . htmlspecialchars($_SESSION['img'] ?? '', ENT_QUOTES, 'UTF-8') . "' />"; ?>
      ...
      <div class="collapse z-3 position-absolute rounded-bottom text-center mt-2 f" id="vv">
        <?php
        echo "<img class='rounded-circle bg-light' width='90px' height='90px' src='" . htmlspecialchars($_SESSION['img'] ?? '', ENT_QUOTES, 'UTF-8') . "' />";
        ...
        echo "<input class='form-control' type='text' hidden name='id' value='" . (int)($_SESSION['id'] ?? 0) . "'/>";
